...
<div style="display: flex; flex-wrap: wrap; justify-content: space-around;">
    ...
    <div style="border: 2px solid #000; width: 300px; height: 300px; text-align: center; margin: 10px; background-color: #f9f9f9; padding: 10px; display: flex; flex-direction: column; justify-content: left; align-items: center;">
